/// Reliable cover photo URLs for listings without user uploads.
///
/// Uses curated Unsplash photo IDs of real Indian apartments, houses,
/// villas, and shared spaces — stable direct URLs that never 404.
abstract final class ListingSampleImages {
  static const _width = 400;
  static const _height = 300;

  static const _rentPhotos = [
  ...
  static String fallbackFor(String listingId) =>
      urlFor(listingId.isEmpty ? 'fallback' : listingId, 'Rent');
}
